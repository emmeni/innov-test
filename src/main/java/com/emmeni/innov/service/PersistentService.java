...
import com.emmeni.innov.repository.PersistentRepository;
...
@Slf4j
@Data
public abstract class PersistentService<P extends IPersistent> {
	...
	public P save(P entity, Locale locale) {
		...
		try {
			if (entity == null) {
				String message = messageSource.getMessage("unable.to.save.null.object", new Object[] { entity }, locale);
			...
			throw new InnovException(HttpStatus.INTERNAL_SERVER_ERROR.value(), message);
		}
	}
